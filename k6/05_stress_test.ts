 ...
 *
 * Run: k6 run k6/05_stress_test.ts --env BASE_URL=http://localhost:5000
 */

import http from 'k6/http'
import { check, group, Response } from 'k6'
import { BASE_URL, API_VERSION, COMMON_HEADERS, THRESHOLDS } from './config.ts'
...
export default function (): void {
  group('Stress Test - Read Heavy Operations', (): void => {
    group('Get Restaurants', (): void => {
