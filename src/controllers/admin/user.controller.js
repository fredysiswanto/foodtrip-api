...
exports.getRestoAdmin = async (req, res) => {
  ...
  try {
      ...
      include: [
        {
          model: db.Restaurant,
          as: 'restaurant',
          include: ['restaurant_category', 'resto_address']
        }
      ],
    ...
    dataResponse(
      res,
      data,
      'Resto Admin has been retrieved',
      'No Resto Admin has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.getCustomer = async (req, res) => {
  ...
  try {
    const data = await db.User.findOne({
      where: { user_type: 'Customer', user_id: id },
      include: ['addresses']
    })
    dataResponse(
      res,
      ...
      'No Customer has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.getAdmin = async (req, res) => {
  ...
  try {
    const data = await db.User.findOne({
      where: { user_type: 'Admin', user_id: id }
    })
    dataResponse(
      res,
      data,
      'Admin has been retrieved',
      'No Admin has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
