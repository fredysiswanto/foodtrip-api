...
exports.getAllRestaurants = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      res,
      data,
      'All Restaurants has been retrieved',
      'No Restaurants has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.getAllRestoCat = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      res,
      data,
      'All Restaurant Category has been retrieved',
      'No Restaurant Category has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.getRestoCat = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      res,
      data,
      'Restaurant Category has been retrieved',
      'No Restaurant Category has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
