...
exports.getAllOrders = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      res,
      data,
      'All Orders has been retrieved',
      'No Orders has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.inProcess = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      ...
      'No Order Status has been updated'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.otw = async (req, res) => {
  ...
  try {
    ...
    const data = await db.DeliveryDetails.create(req.body)
    dataResponse(
      res,
      data,
...
exports.delivered = async (req, res) => {
  ...
  const id = req.params.orderID
  const orderDetails = await db.Order.findByPk(id, {
    include: ['delivery_details']
  })

  try {
    await db.Order.update(
      { order_status: 'Delivered', updated_by: req.user.user_id },
      { where: { order_id: id } }
    )
