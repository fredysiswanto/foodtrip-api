...
exports.getRestaurant = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      res,
      data,
      'Restaurant has been retrieved',
      'No Restaurant has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.updateRestaurant = async (req, res) => {
  ...
  try {
    const restoImg = await db.Restaurant.findByPk(id, {
      attributes: ['resto_img']
    })
...
exports.getAllOpeningHours = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      res,
      data,
      'All Opening Hours has been retrieved',
      'No Opening Hours has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
...
exports.getOpeningHour = async (req, res) => {
  ...
  try {
    ...
    dataResponse(
      res,
      data,
      'Opening Hour has been retrieved',
      'No Opening Hour has been retrieved'
    )
  } catch (err) {
    errResponse(res, err)
  }
  ...
  try {
    ...
    if (result) {
      const data = await db.OpeningHour.findByPk(id, {
        include: ['updated', 'restaurant']
      })
      dataResponse(
        res,
        data,
        'Opening has been successfully updated',
        'No Opening has been successfully updated'
      )
    } else {
