...
const restaurantCtl = require('../controllers/resto_admin/restaurants.controller')
...
router.put(
  '/restaurant/:restoID',
  updateRestoImage,
  restaurantCtl.updateRestaurant
)

const dishCtl = require('../controllers/resto_admin/dishes.controller')
...
const orderCtl = require('../controllers/resto_admin/orders.controller')
...
const courierCtl = require('../controllers/resto_admin/couriers.controller')
router.get('/couriers', courierCtl.getAllCouriers)

const acctInfoCtl = require('../controllers/resto_admin/acc_info.controller')
